export const environment = {
  ...
  COUNTRIES: [
    ...
    { id: 'ala-aland-islands', name: 'ALA Aland Islands' },
    ...
    { id: 'brunei', name: 'Brunei Darussalam' },
    ...
    { id: 'congo-brazzaville', name: 'Congo (Brazzaville)' },
    { id: 'congo-kinshasa', name: 'Congo (Kinshasa)' },
    ...
    { id: 'haiti', name: 'Haiti' },
    { id: 'heard-and-mcdonald-islands', name: 'Heard and Mcdonald Islands' },
    {
      id: 'holy-see-vatican-city-state',
      name: 'Holy See (Vatican City State)',
    },
    { id: 'honduras', name: 'Honduras' },
    { id: 'hong-kong-sar-china', name: 'Hong Kong, SAR China' },
    { id: 'hungary', name: 'Hungary' },
    { id: 'iceland', name: 'Iceland' },
    { id: 'india', name: 'India' },
    { id: 'indonesia', name: 'Indonesia' },
    { id: 'iran', name: 'Iran, Islamic Republic of' },
    { id: 'iraq', name: 'Iraq' },
    ...
    { id: 'macao-sar-china', name: 'Macao, SAR China' },
    { id: 'macedonia', name: 'Macedonia, Republic of' },
    ...
    { id: 'micronesia', name: 'Micronesia, Federated States of' },
    ...
    { id: 'palau', name: 'Palau' },
    { id: 'palestine', name: 'Palestinian Territory' },
    ...
    { id: 'qatar', name: 'Qatar' },
    { id: 'kosovo', name: 'Republic of Kosovo' },
    { id: 'réunion', name: 'Réunion' },
    { id: 'romania', name: 'Romania' },
    { id: 'russia', name: 'Russian Federation' },
    ...
    { id: 'syria', name: 'Syrian Arab Republic (Syria)' },
    { id: 'taiwan', name: 'Taiwan, Republic of China' },
    { id: 'tajikistan', name: 'Tajikistan' },
    { id: 'tanzania', name: 'Tanzania, United Republic of' },
    ...
    { id: 'united-states', name: 'United States of America' },
    { id: 'uruguay', name: 'Uruguay' },
    { id: 'us-minor-outlying-islands', name: 'US Minor Outlying Islands' },
    { id: 'uzbekistan', name: 'Uzbekistan' },
    { id: 'vanuatu', name: 'Vanuatu' },
    { id: 'venezuela', name: 'Venezuela (Bolivarian Republic)' },
    { id: 'vietnam', name: 'Viet Nam' },
    { id: 'virgin-islands', name: 'Virgin Islands, US' },
    { id: 'wallis-and-futuna-islands', name: 'Wallis and Futuna Islands' },
